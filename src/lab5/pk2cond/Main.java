...
public class Main {
        ...
        public static void main(String[] args) throws InterruptedException, IOException {
            ...
            while (j < threadsNumber){
                consumers[j] = new Consumer(buffer, bufferSize, j, seed);
                producers[j] = new Producer(buffer, bufferSize, j, seed);
...
//            sleep(30000);
    ...
    public static void printWaitingLoops() throws IOException {
        ...
        for (int i = 0; i < threadsNumber; i++){
            if (producers[i] != null){
                ...
                writer.write("producer2condbool,"+bufferSize+","+threadsNumber+","+i+","+producers[i].loops+"\n");
            }
        }
        System.out.println("==========================================");
        for (int i = 0; i < threadsNumber; i++){
            if (consumers[i] != null) {
                ...
                writer.write("consumer2condbool,"+bufferSize+","+threadsNumber+","+i+","+consumers[i].loops+"\n");
            }
        }
        System.out.println("**** **** **** ****  ****  **** **** **** ****");
    ...
    public static void printAverageTimes() throws IOException {
        ...
        for (int i = 1; i < bufferSize; i++){
            writer.write("get2condbool,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i)+"\n");
            System.out.println("get2condbool,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i));
        }

        for (int i = 1; i < bufferSize; i++){
            writer.write("put2condbool,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i)+"\n");
            System.out.println("put2condbool,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i));
        }
