    ...
    public static void printWaitingLoops() throws IOException {
        ...
        for (int i = 0; i < threadsNumber; i++){
            if (producers[i] != null){
                ...
                writer.write("producer4condbool,"+bufferSize+","+threadsNumber+","+i+","+producers[i].loops+"\n");
            }
        }
        System.out.println("==========================================");
        for (int i = 0; i < threadsNumber; i++){
            if (consumers[i] != null) {
                ...
                writer.write("consumer4condbool,"+bufferSize+","+threadsNumber+","+i+","+consumers[i].loops+"\n");
            }
        }
        System.out.println("**** **** **** ****  ****  **** **** **** ****");
