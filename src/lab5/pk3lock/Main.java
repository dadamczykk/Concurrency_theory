...
//            sleep(30000);
    ...
    public static void printWaitingLoops() throws IOException {
        ...
        for (int i = 0; i < threadsNumber; i++){
            if (producers[i] != null){
                ...
                writer.write("producer3lock,"+bufferSize+","+threadsNumber+","+i+","+producers[i].loops+"\n");
            }
        }
        System.out.println("==========================================");
        for (int i = 0; i < threadsNumber; i++){
            if (consumers[i] != null) {
                ...
                writer.write("consumer3lock,"+bufferSize+","+threadsNumber+","+i+","+consumers[i].loops+"\n");
            }
        }
        System.out.println("**** **** **** ****  ****  **** **** **** ****");
    ...
    public static void printAverageTimes() throws IOException {
        ...
        for (int i = 1; i < bufferSize; i++){
            writer.write("get3lock,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i)+"\n");
            System.out.println("get3lock,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i));
        }

        for (int i = 1; i < bufferSize; i++){
            writer.write("put3lock,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i)+"\n");
            System.out.println("put3lock,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i));
        }
