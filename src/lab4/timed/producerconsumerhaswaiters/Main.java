...
//            }
    ...
    public static void printAverageTimes() throws IOException {
        ...
        for (int i = 1; i < bufferSize; i++){
            writer.write("get4condwaiters,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i)+"\n");
            System.out.println("get4condwaiters,"+bufferSize+","+threadsNumber+","+i+","+getMeans.get(i));
        }

        for (int i = 1; i < bufferSize; i++){
            writer.write("put4condwaiters,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i)+"\n");
            System.out.println("put4condwaiters,"+bufferSize+","+threadsNumber+","+i+","+putMeans.get(i));
        }
